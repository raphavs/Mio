    ...
    <div class="card-body">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
                <label for="name" class="col-md-4 col-lg-4 my-col-form-label text-md-right">{{ __('Name') }}</label>
            ...
            <div class="form-group row">
                <label for="password-confirm" class="col-md-4 col-lg-4 my-col-form-label text-md-right">{{ __('Confirm Password') }}</label>
                <div class="col-md-6 col-lg-5">
