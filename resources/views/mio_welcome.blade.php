...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="../../resources/assets/Image/carousel5.jpg" alt="First slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="../../resources/assets/Image/carousel6.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="../../resources/assets/Image/carousel3.jpg" alt="Third slide">
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col-md-12 col-lg-6 my-about-padding">
                    ...
                    <button id="my-readmore-btn" class="btn btn-readmore" type="button">read more ...</button>
                </div>
                <div class="col-md-12 col-lg-6 my-about-padding">
                    <img src="../../resources/assets/Image/Smartphone_Laptop.jpg" class="img-fluid rounded" alt="PictureOfUser">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-xs-12 col-sm-6 col-md-4 my-user-padding">
                <img src="../../resources/assets/Image/user.png" class="img-fluid" alt="User">
                <h3>Clients</h3>
