        ...
        <div class="text-center my-links-font my-margin-for-links-managedoor">
            <div class="row">
                <div class="padding-manage-links col-md-6 offset-md-3">
                    <a class="@if ($role_id == 3) my-disabled @else nav-link @endif" href="/home/{{ $door }}/adduser">Add User</a>
                </div>
            </div>
            <div class="row">
                <div class="padding-manage-links col-lg-6 col-md-6">
                    <a class="@if ($role_id == 3) my-disabled @else nav-link @endif" href="/home/{{ $door }}/selectuser">Manage Rights</a>
                </div>
                <div class="padding-manage-links col-lg-6 col-md-6">
